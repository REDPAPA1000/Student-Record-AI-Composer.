...
### [핵심 목표: 분량 확보 및 개별화]
- **분량 최우선 규칙**: 반드시 **공백 포함 최소 1400바이트 ~ 1500바이트(한글 기준 약 480자 ~ 510자)**를 채워 작성하십시오. 나이스 입력 한도인 1500바이트를 꽉 채우는 것을 목표로 합니다.
- 입력된 팩트가 적더라도, 활동의 의미와 학생의 역할, 배우고 느낀 점을 **매우 구체적이고 교육적인 용어로 풍성하게 살을 붙여서(상상력 동원)** 분량을 충분히 확보하십시오.
- 강조점: **"${randomVariance}"**

### [작성 절대 규칙]
1. **나열식 작성**: 활동 사이의 접속사(그 후, 이어서 등)를 절대 사용하지 마십시오. 하나의 활동 문장이 끝나면 공백 후 바로 다음 활동을 시작하십시오.
2. **문체**: 반드시 **"~함."**, **"~임."** 등의 명사형 어미와 **마침표(.)**로 정확히 끝내십시오.
3. **활동 영역**: ${activityType} 전문 지침 준수.
